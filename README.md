...
| **2** | **The working prototype** — live lead ledger dashboard | [*[Vercel link]*](https://clever-lead-ledger.vercel.app/) |
...
### `/docs`
- **`field-dictionary-and-taxonomy.md`** — every source field, what it actually contains, the cleaning rule applied, and the full outcome taxonomy with its rules. This is the backing work that makes the dashboard numbers defensible.
